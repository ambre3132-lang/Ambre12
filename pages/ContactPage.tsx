...
const ContactPage: React.FC = () => {
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <h1 className="text-3xl sm:text-4xl font-serif font-bold text-center mb-10 text-brand-gray">{t('contact_us')}</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="bg-white p-8 rounded-lg shadow-lg text-center flex flex-col items-center justify-center h-full">
                    <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-brand-gray">{t('contact_whatsapp_prompt')}</h2>
                ...
                <div>
                     <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-brand-gray">{t('our_location')}</h2>
                     ...
                     <div className="mt-6 h-[300px] bg-gray-300 rounded-lg overflow-hidden shadow-md">
                        <iframe 
